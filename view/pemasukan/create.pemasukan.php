  ...
  <div class="md:grid md:grid-cols-3 md:gap-6">
    <div class="md:col-span-1">
      <div class="px-4 sm:px-0">
        <h3 class="text-lg font-medium leading-6 text-gray-900">Tambah Pemasukan</h3>
        <p class="mt-1 text-sm text-gray-600">
          Tambahkan Pemasukan baru ke dalam database.
        </p>
      </div>
    </div>
    <div class="mt-5 md:mt-0 md:col-span-2">
      <form action="action.php?create=pemasukan" method="POST">
          ...
          <div class="px-4 py-5 bg-white sm:p-6">
            <div class="grid grid-cols-6 gap-6">
              ...
              <div class="border-2 p-2 bg-blue-100 rounded-xl col-span-6 sm:col-span-4">
                ...
                <input type="text" name="total_barang" placeholder="10" class="ml-2 outline-none w-full bg-blue-100">
              </div>
